...
sealed class Destino(val route: String, val icon: Int, val title: String) {
    ...
    object EcraSettings : Destino(route = "EcraSettings", icon = R.drawable.baseline_app_settings_alt_24, title = "Settings")
    ...
    object NoteCreation : Destino(route = "noteCreation", icon = R.drawable.baseline_settings_24, title = "Create Note")


    companion object {
        val toList = listOf(EcraLoginFirebase,EcraRegisterToFirebase,EcraSettings,NoteList1, NoteList2, NoteCreation)
    }
}